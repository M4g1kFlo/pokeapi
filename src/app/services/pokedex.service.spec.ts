...
describe('PokedexService', () => {
  ...
  it('should make a call GET reuqest', () => {
    service.getPokemonInfos("ditto")
    const request = httpController.expectOne("https://pokeapi.co/api/v2/pokemon/ditto")
  ...
  it('should be called to the right URL', () => {
    service.getPokemonInfos("ditto")
    const url = "https://pokeapi.co/api/v2/pokemon/ditto"
    const request = httpController.match(url)
  ...
  it('should call the GET method with httpClient', () => {
